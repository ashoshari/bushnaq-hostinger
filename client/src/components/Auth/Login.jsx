...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password.length < 6) {
      errors.password = t("loginPage.errPassword");
    }
    ...
    if (!Object.keys(errors).length) {
      ...
      const res = await fetch("https://bunaq-api.vercel.app/api/login", {
        method: "POST",
      ...
      if (data.message || data.errors) {
        setDisableBtn(false);
        setErrLogin(t("loginPage.invCredentials"));
      } else {
        const isAdmin = data.isAdmin[0][0].isAdmin;
  ...
  return (
    <div>
      <section className="paddingTop" data-aos="fade-up">
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <button
                            ...
                            className="btn btn-lg text-white bgOrangish btnHover"
